          ...
          version === BUTTON_VERSIONS.default
            ...
            : version === BUTTON_VERSIONS.green
              ...
              : version === BUTTON_VERSIONS.discard
                ...
                : version === BUTTON_VERSIONS.unfollow
                  ? "text-primaryGray hover:text-white border border-primaryGray hover:bg-secondaryGray py-2 px-4 active active:bg-primaryGray"
                  : ""
        } 
        font-noto-sans rounded-md cursor-pointer select-none disabled:opacity-60 disabled:pointer-events-none active:opacity-80 transition-opacity`}
    >
      {children}
    </button>
  );
